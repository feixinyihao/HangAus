...
- (void)ba_layoutSubViews
{
    ...
    if (self.buttonPositionType == BAKit_PickerViewButtonPositionTypeNormal)
    {
        ...
        self.contentTitleLabel.frame = CGRectMake(80, min_y, min_bgView_w - 160, min_h);
    }
...
- (UIButton *)cancleButton
{
    if (!_cancleButton)
    {
        ...
        [self.cancleButton setTitle:KLocalizedString(@"6000011") forState:UIControlStateNormal];
...
- (UIButton *)sureButton
{
    if (!_sureButton)
    {
        ...
        [self.sureButton setTitle:KLocalizedString(@"6000010") forState:UIControlStateNormal];
...
- (UIWindow *)alertWindow
{
    if (!_alertWindow)
    {
        ...
        self.alertWindow.backgroundColor = BAKit_Color_White_pod;
    }
    return _alertWindow;
}
